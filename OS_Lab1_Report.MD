...
У результаті виконання лабораторної роботи №1 я набув практичних навичок роботи у командному рядку в Linux. Ознайомився з базовими командами адміністрації облікового запису, моніторингу активних користувачів, а також з довідковою системою, утилітами посторінкового перегляду та командами навігації у файловій системі. Це було дуже цікаво
